...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\linewidth}{c X c}
      ...
      11 & Calcola l'importo totale di un ordine & 66 al mese \\
...
\begin{table}[H]
    ...
    \begin{tabular}{ c c c c }
        ...
        BADGE & E & 1 & S \\
    \end{tabular}\\
    \( 3S \rightarrow 33 \) al mese = \( 3S \times 2 \times 33 = 198 \) al mese
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{ c c c c }
        ...
        \( 18L  \rightarrow 14 \) al mese = \( 252 \) al mese
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{ c c c c } 
        ...
        SUPERCAR & E & 2 & L \\ 
    \end{tabular}\\
    \( 4S + 8L \rightarrow \) 66 al mese = \( 4S \times 2 \times 66 + 6L \times
    66 = 1056\) al mese
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{ c c c c } 
        ...
        SUPERCAR & E & 1 & S \\ 
    \end{tabular}\\
    \(8S + 1L \rightarrow \) 1.6 al mese = \( 8S \times 2 \times 1.6 + 1L \times
    1.6 = 27.2 \) al mese  
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{c c c c}
        ...
        OPTIONAL & E & 11 & L \\
    \end{tabular}\\
    \( 31L \rightarrow 5 \) all'anno = \( 155 \) all'anno
\end{table}
